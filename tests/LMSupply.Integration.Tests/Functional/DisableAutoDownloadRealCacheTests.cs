...
/// ignored the option and downloaded anyway. The unit tests count requests through a test transport; this
...
public sealed class DisableAutoDownloadRealCacheTests
{
    public static TheoryData<string> Modules =>
        ["transcriber", "translator", "reranker", "segmenter", "detector", "imagegenerator", "ocr"];
